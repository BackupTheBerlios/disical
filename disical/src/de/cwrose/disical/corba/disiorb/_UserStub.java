                       ...
                       implements User
{
    ...
    changePW(String _ob_a0)
    {
        while(true)
        {
            ...
            {
                org.omg.CORBA.portable.ServantObject _ob_so = _servant_preinvoke("changePW", _ob_opsClass);
                if(_ob_so == null)
                    continue;
                UserOperations _ob_self = (UserOperations)_ob_so.servant;
                try
                {
                    _ob_self.changePW(_ob_a0);
                    return;
                }
                finally
                {
    ...
    getUserInfo()
    {
        while(true)
        {
            ...
            {
                org.omg.CORBA.portable.ServantObject _ob_so = _servant_preinvoke("getUserInfo", _ob_opsClass);
                if(_ob_so == null)
                    continue;
                UserOperations _ob_self = (UserOperations)_ob_so.servant;
                try
                {
                    return _ob_self.getUserInfo();
                }
                finally
                {
                    _servant_postinvoke(_ob_so);
    ...
    setUserInfo(User _ob_a0)
    {
        while(true)
        {
            ...
            {
                org.omg.CORBA.portable.ServantObject _ob_so = _servant_preinvoke("setUserInfo", _ob_opsClass);
                if(_ob_so == null)
                    continue;
                UserOperations _ob_self = (UserOperations)_ob_so.servant;
                try
                {
                    _ob_self.setUserInfo(_ob_a0);
                    return;
                }
                finally
                {
