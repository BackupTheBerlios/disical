...
//
final public class InvitationHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "Invitation");
        }
    ...
    id()
    {
        return "IDL:de/cwrose/disical/corba/disiorb/Invitation:1.0";
    }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _InvitationStub _ob_stub = new _InvitationStub();
